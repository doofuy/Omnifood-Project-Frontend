...
- Logo + Navigation
- Hero 
- Featured in section is mostly right after the hero section or even in the hero section.
- How it works
- Meals(and list of diets)
- Testimonials + Gallery
- Pricing comes very low on te page moslty right before call to action section
  Feature this we will combine with the pricings
- CTA Note call to action section is usually the last section before footer.
- Footer
